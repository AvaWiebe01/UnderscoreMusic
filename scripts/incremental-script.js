...
resource1Delta[0] = 567.89; resource1Delta[1] = 0; resource1Delta[2] = 0; resource1Delta[3] = 0; resource1Delta[4] = 0; resource1Delta[5] = 0;
...
function updateResources() {
    ...
    for (let i = 0; i < Math.min(resource1.length, resource1Delta.length); i++) {
        resource1[i] = resource1[i] + ((resource1Delta[i]/REFRESH_RATE) * resource1Multiplier);
