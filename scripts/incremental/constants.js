...
static ALL_UPGRADES_INFO = new Map([ // resourceName, upgradesList
    [
        ...
        [ // key : title, description, flavorText, cost, buyAction
            ...
            ["arcMult1", "ArcMult v1.0", "<strong>Decrypting</strong> ArcBits provides a temporary multiplier to <strong>process</strong> ArcBit generation.", "", 1, (resource) => resource.addDeltaMultSource(arcMult1)],
        ]
    ],
]);
