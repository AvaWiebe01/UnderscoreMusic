    ...
    [
        ...
        new Map([ // resourceName, upgradesList
            [
                "nullpointers",
                [
                    /*initial upgrade*/["nullBtn1", "efficient_search_ver1", "<strong>nullpointer_location_chance=0.015;</strong>", "", 1, ["nullBtn2"], (resource) => {resource.modifySuccessRate(0.015)}],
                    ["nullBtn2", "efficient_search_ver2", "<strong>nullpointer_location_chance=0.0275;</strong>", "", 8, ["nullBtn3"], (resource) => {resource.modifySuccessRate(0.0275)}],
                    ["nullBtn3", "efficient_search_ver3", "<strong>nullpointer_location_chance=0.075;</strong>", "", 35, ["nullBtn4"], (resource) => {resource.modifySuccessRate(0.075)}],
                    ["nullBtn4", "efficient_search_ver4", "<strong>nullpointer_location_chance=0.1;</strong>", "", 300, ["nullBtn5"], (resource) => {resource.modifySuccessRate(0.1)}],
                    ["nullBtn5", "efficient_search_finalver", "<strong>nullpointer_location_chance=0.175; //need new algorithm</strong>", "", 750, ["nullBtn6"], (resource) => {resource.modifySuccessRate(0.175)}],
                    ["nullBtn6", "nullspace_collapse_protocol", "<strong>nullpointer_location_chance=0.25;</strong>", "", 1_250, ["nullBtn7"], (resource) => {resource.modifySuccessRate(0.25)}],
                    ["nullBtn7", "nullspace_collapse_protocol_v2", "<strong>nullpointer_location_chance=0.32;</strong>", "", 3_800, ["nullBtn8"], (resource) => {resource.modifySuccessRate(0.32)}],
                    ["nullBtn8", "nullspace_collapse_protocol_v2.1", "<strong>nullpointer_location_chance=0.4525;</strong>", "", 64_200, ["nullBtn9"], (resource) => {resource.modifySuccessRate(0.4525)}],
                    ["nullBtn9", "nullspace_collapse_protocol_v2.1.1", "<strong>nullpointer_location_chance=0.5;</strong>", "", 1_800_000, ["nullBtn10"], (resource) => {resource.modifySuccessRate(0.5)}],
                    ["nullBtn10", "nullspace_collapse_protocol_v5", "<strong>nullpointer_location_chance=0.5555; //seems like the limit</strong>", "", 55_555_555, [], (resource) => {resource.modifySuccessRate(0.5555)}],
